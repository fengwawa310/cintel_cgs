...
<script src="${pageContext.request.contextPath}/hui/js/plugins/echarts/echarts-all.js"></script>
<script src="j${pageContext.request.contextPath}/hui/s/content.min.js?v=1.0.0"></script>
<script src="${pageContext.request.contextPath}/hui/js/demo/echarts-demo.min.js"></script>
