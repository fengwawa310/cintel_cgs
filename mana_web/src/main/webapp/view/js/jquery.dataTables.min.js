    ...
    var O = function(h) {
        ...
        function eb(a) {
            ...
            if (a = a.aoSearchCols) for (var b = 0,
                                             c = a.length; b < c; b++) a[b] && H(o.models.oSearch, a[b])
        }
        function fb(a) {
        ...
        function ka(a, b, c) {
            ...
            c !== k && null !== c && (fb(c), H(o.defaults.column, c), c.mDataProp !== k && !c.mData && (c.mData = c.mDataProp), c.sType && (b._sManualType = c.sType), c.className && !c.sClass && (c.sClass = c.className), h.extend(b, c), E(b, c, "sWidth", "sWidthOrig"), "number" === typeof c.iDataSort && (b.aDataSort = [c.iDataSort]), E(b, c, "aDataSort"));
            var g = b.mData,
                j = W(g),
        ...
        function J(a, b, c, e) {
            ...
            for (var b = a.aoColumns,
                     f = 0,
                     g = b.length; f < g; f++) c && Ia(a, d, f, y(a, d, f)),
                b[f].sType = null;
        ...
        function y(a, b, c, e) {
            ...
            if (c === k) return a.iDrawError != d && null === j && (R(a, 0, "Requested unknown parameter " + ("function" == typeof f.mData ? "{function}": "'" + f.mData + "'") + " for row " + b, 4), a.iDrawError = d),
                j;
            ...
            var d = [],
                ...
                a = function(a) {
                    if (c === k || c === j) g = m[j],
                        ...
                        g && g._bAttrSrc ? (Q(g.mData._)(e, i), p(g.mData.sort, a), p(g.mData.type, a), p(g.mData.filter, a)) : l ? (g._setter || (g._setter = Q(g.mData)), g._setter(e, i)) : e[j] = i;
                    j++
                };
            if (f) for (; f;) {
        ...
        function ea(a, b, c) {
            ...
            if (b) {
                ...
                for (d = g.length; e < d; e++) {
                    ...
                    f = 0;
                    for (b = g[e].length; f < b; f++) if (m = i = 1, j[e][f] === k) {
        ...
        function tb(a) {
            ...
            for (g = 0; g < c; g++) m = b[g],
                ...
                n("mDataProp_" + g, i),
            e.bFilter && (n("sSearch_" + g, l.sSearch), n("bRegex_" + g, l.bRegex), n("bSearchable_" + g, m.bSearchable)),
            e.bSort && n("bSortable_" + g, m.bSortable);
        ...
        function yb(a) {
            ...
            for (f = a.aoData.length; e < f; e++) if (h = a.aoData[e], !h._aFilterData) {
                ...
                for (g = b.length; d < g; d++) c = b[d],
                    c.bSearchable ? (i = y(a, e, d, "filter"), l[c.sType] && (i = l[c.sType](i)), null === i && (i = ""), "string" !== typeof i && i.toString && (i = i.toString())) : i = "",
        ...
        function Y(a) {
            ...
            if (r.outerWidth() < g) {
                ...
                if (w && (i.scrollHeight > i.offsetHeight || "scroll" == p.css("overflow-y"))) u.width = s(v - f); ("" === c || "" !== e) && R(a, 1, "Possible column misalignment", 6)
            } else v = "100%";
            n.width = s(v);
            j.width = s(v);
            K && (a.nScrollFoot.style.width = s(v)); ! d && w && (n.height = s(t.offsetHeight + f));
            ...
            m[ha] = l ? f + "px": "0px";
            K && (q[0].style.width = s(b), k[0].style.width = s(b), k[0].style[ha] = l ? f + "px": "0px");
            p.scroll();
        ...
        function Ga(a) {
            var b = a.nTable,
                ...
                n,
                k;
            for (n = 0; n < e.length; n++) k = c[e[n]],
            null !== k.sWidth && (k.sWidth = Db(k.sWidthOrig, l), p = !0);
            if (!p && !f && !d && j == aa(a) && j == i.length) for (n = 0; n < j; n++) c[n].sWidth = s(i.eq(n).width());
            else {
                ...
                for (n = 0; n < e.length; n++) k = c[e[n]],
                    i[n].style.width = null !== k.sWidthOrig && "" !== k.sWidthOrig ? s(k.sWidthOrig) : "";
                if (a.aoData.length) for (n = 0; n < e.length; n++) p = e[n],
                    k = c[p],
                    h(Eb(a, p)).clone(!1).append(k.sContentPadding).appendTo(q);
                j.appendTo(l);
                f && g ? j.width(g) : f ? (j.css("width", "auto"), j.width() < l.offsetWidth && j.width(l.offsetWidth)) : d ? j.width(l.offsetWidth) : m && j.width(m);
                Fb(a, j[0]);
                if (f) {
                    for (n = g = 0; n < e.length; n++) k = c[e[n]],
                        d = h(i[n]).outerWidth(),
                        g += null === k.sWidthOrig ? d: parseInt(k.sWidth, 10) + d - h(i[n]).width();
                    j.width(s(g));
                    b.style.width = s(g)
                }
                for (n = 0; n < e.length; n++) if (k = c[e[n]], d = h(i[n]).width()) k.sWidth = s(d);
        ...
        function Gb(a, b) {
            for (var c, e = -1,
                     d = -1,
                     f = 0,
                     g = a.aoData.length; f < g; f++) c = y(a, f, b, "display") + "",
                c = c.replace($b, ""),
        ...
        function T(a) {
            ...
            var m = [];
            f = function(a) {
                a.length && !h.isArray(a[0]) ? m.push(a) : m.push.apply(m, a)
            };
            h.isArray(b) && f(b);
            c && b.pre && f(b.pre);
            f(a.aaSorting);
            ...
            for (a = 0; a < m.length; a++) {
                ...
                for (c = f.length; b < c; b++) g = f[b],
                    j = d[g].sType || "string",
                m[a]._idx === k && (m[a]._idx = h.inArray(m[a][1], d[g].asSorting)),
                    e.push({
                        src: i,
                        col: g,
                        dir: m[a][1],
        ...
        function Jb(a) {
            for (var b, c, e = a.aoColumns,
                     d = T(a), a = a.oLanguage.oAria, f = 0, g = e.length; f < g; f++) {
                c = e[f];
                var h = c.asSorting;
        ...
        function Ib(a, b) {
            ...
            for (var f, g = o.ext.type.order[c.sType + "-pre"], h = 0, i = a.aoData.length; h < i; h++) if (c = a.aoData[h], c._aSortData || (c._aSortData = []), !c._aSortData[b] || e) f = e ? d[h] : y(a, h, b, "sort"),
        ...
        o = function(a) {
            ...
            this.each(function() {
                ...
                if ("table" != this.nodeName.toLowerCase()) R(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
                    ...
                    if (null === i || "" === i) this.id = i = "DataTables_Table_" + o.ext._unique++;
                    var q = h.extend(!0, {},
                        o.models.oSettings, {
                            nTable: this,
                            oApi: b.internal,
                    ...
                    E(q.oScroll, d, [["sScrollX", "sX"], ["sScrollXInner", "sXInner"], ["sScrollY", "sY"], ["bScrollCollapse", "bCollapse"]]);
                    ...
                    z(q, "aoFooterCallback", d.fnFooterCallback, "user");
                    ...
                    p.addClass(i.sTable);
                    if ("" !== q.oScroll.sX || "" !== q.oScroll.sY) q.oScroll.iBarWidth = Hb(); ! 0 === q.oScroll.sX && (q.oScroll.sX = "100%");
                    ...
                    null === d.asStripeClasses && (q.asStripeClasses = [i.sStripeOdd, i.sStripeEven]);
                    var g = q.asStripeClasses,
                        s = h("tbody tr", this).eq(0); - 1 !== h.inArray(!0, h.map(g,
                        function(a) {
                            return s.hasClass(a)
                    ...
                    z(q, "aoDrawCallback",
                        function() { (q.bSorted || B(q) === "ssp" || v.bDeferRender) && xa(q)
                        },
                        "sc");
                    gb(q);
        ...
        t.prototype = {
            ...
            iterator: function(a, b, c, e) {
                ...
                for (h = l.length; g < h; g++) {
                    var q = new t(l[g]);
                    if ("table" === b) f = c.call(q, l[g], g),
                    f !== k && d.push(f);
                    else if ("columns" === b || "rows" === b) f = c.call(q, l[g], this[g], g),
                    f !== k && d.push(f);
                    else if ("column" === b || "column-rows" === b || "row" === b || "cell" === b) {
                        n = this[g];
                        "column-rows" === b && (p = Ca(l[g], o.opts));
                        i = 0;
                        for (m = n.length; i < m; i++) f = n[i],
                            f = "cell" === b ? c.call(q, l[g], f.row, f.column, g, i) : c.call(q, l[g], f, g, i, p),
                        f !== k && d.push(f)
                    }
                }
                return d.length || e ? (a = new t(l, a ? d.concat.apply([], d) : d), b = a.selector, b.rows = o.rows, b.cols = o.cols, b.opts = o.opts, a) : this
            },
                ...
                var b = this.iterator("table",
                        function(b) {
                            ...
                            for (g = a.length; f < g; f++) c = a[f],
                                c.nodeName && "TR" === c.nodeName.toUpperCase() ? h.push(ma(b, c)[0]) : h.push(J(b, c));
                            return h
                        },
                        1),
                    c = this.rows( - 1);
        ...
        r("row().child()",
            function(a, b) {
                ...
                if (!0 === a) this.child.show();
                    ...
                    if (h.isArray(a) || a instanceof h) for (var g = 0,
                                                                 j = a.length; g < j; g++) f(a[g], b);
                    else f(a, b);
            ...
            function(a) {
                ...
                return this.iterator("table",
                    function(b) {
                        ...
                        f.children().detach();
                        f.append(l);
                        i.css("width", b.sDestroyWidth).removeClass(e.sTable); (p = b.asDestroyStripes.length) && f.children().each(function(a) {
